...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    "auth.phone_placeholder": "0901 234 567",
    ...
    "auth.agree": "Tôi đồng ý với",
    "auth.terms": "Điều khoản sử dụng",
    "auth.and": "và",
    "auth.privacy": "Chính sách bảo mật",

    // Onboarding
    "onboarding.step_back": "Quay lại",
    "onboarding.step_next": "Tiếp theo →",
    "onboarding.step1_title": "Xin chào! Hãy cho chúng tôi biết về bạn 👋",
    "onboarding.step1_desc": "Chúng tôi sẽ tùy chỉnh lộ trình học phù hợp nhất với bạn",
    "onboarding.step2_title": "Bạn muốn phát triển kỹ năng gì?",
    "onboarding.step2_desc": "Có thể chọn nhiều lĩnh vực",
    "onboarding.step2_count": "Đã chọn",
    "onboarding.step2_field": "lĩnh vực",
    "onboarding.step3_title": "Điều gì đang cản trở bạn phát triển?",
    "onboarding.step3_desc": "Giúp chúng tôi hiểu để đề xuất đúng giải pháp",
    "onboarding.step3_other": "Thêm vấn đề khác của bạn... (tuỳ chọn)",
    "onboarding.step3_submitting": "Đang hoàn tất hồ sơ và chuyển hướng...",
    "onboarding.step3_finish": "Bắt đầu học ngay 🚀",
    "onboarding.please_wait": "Vui lòng chờ...",

    // Onboarding Data
    "onboarding.role_student": "Sinh viên / Học sinh",
    "onboarding.role_student_desc": "Đang học tại trường, chuẩn bị ra trường",
    "onboarding.role_professional": "Người đi làm",
    "onboarding.role_professional_desc": "Muốn nâng cao kỹ năng trong công việc hiện tại",
    "onboarding.role_changer": "Người chuyển ngành",
    "onboarding.role_changer_desc": "Muốn thay đổi hướng nghề nghiệp",
    "onboarding.role_instructor": "Giảng viên / Chuyên gia",
    "onboarding.role_instructor_desc": "Muốn chia sẻ kiến thức và xây dựng thương hiệu",

    "onboarding.int_management": "Quản trị & Lãnh đạo",
    "onboarding.int_management_desc": "Ra quyết định, quản lý đội nhóm, tư duy chiến lược",
    "onboarding.int_softskills": "Kỹ năng mềm & Giao tiếp",
    "onboarding.int_softskills_desc": "Thuyết trình, đàm phán, xử lý xung đột",
    "onboarding.int_it": "Lập trình & Công nghệ",
    "onboarding.int_it_desc": "Python, web development, tư duy kỹ thuật",
    "onboarding.int_marketing": "Marketing & Truyền thông",
    "onboarding.int_marketing_desc": "Content, quảng cáo số, xây dựng thương hiệu",

    "onboarding.pain_skills": "Thiếu kỹ năng thực tế để xin việc",
    "onboarding.pain_apply": "Học xong không áp dụng được vào thực tế",
    "onboarding.pain_time": "Không có thời gian học tập trung",
    "onboarding.pain_lonely": "Cảm thấy cô đơn, thiếu động lực khi học online",
    "onboarding.pain_start": "Không biết bắt đầu từ đâu",
    "onboarding.pain_theory": "Nội dung quá lý thuyết, không cập nhật",
    ...
    "settings.language_desc": "Chọn ngôn ngữ hiển thị trên toàn hệ thống",
    "settings.profile": "Thông tin cá nhân",
    "settings.profile_desc": "Quản lý định danh và vai trò của bạn",
    "settings.avatar": "Ảnh đại diện của bạn",
    "settings.role_q": "Bạn đang là ai?",
    "settings.name": "Họ và tên",
    "settings.phone": "Số điện thoại",
    "settings.save": "Lưu thay đổi",
    "settings.security": "Bảo mật",
    "settings.security_desc": "Quản lý mật khẩu và an toàn tài khoản",
    "settings.current_pass": "Mật khẩu hiện tại",
    "settings.new_pass": "Mật khẩu mới",
    "settings.confirm_pass": "Xác nhận mật khẩu mới",
    "settings.update_pass": "Cập nhật mật khẩu",
    "settings.email_label": "Email đăng ký",
    "settings.no_change": "KHÔNG THỂ THAY ĐỔI",
    "settings.save_expert": "Lưu hồ sơ chuyên gia",
    "settings.settings_desc": "Quản lý tùy chọn cá nhân và cấu hình hệ thống của bạn.",
  ...
  en: {
    ...
    "auth.phone_placeholder": "123 456 7890",
    ...
    // Onboarding
    "onboarding.step_back": "Go back",
    "onboarding.step_next": "Next step →",
    "onboarding.step1_title": "Hello! Tell us about yourself 👋",
    "onboarding.step1_desc": "We will customize the learning path best suited for you",
    "onboarding.step2_title": "What skills do you want to develop?",
    "onboarding.step2_desc": "You can select multiple fields",
    "onboarding.step2_count": "Selected",
    "onboarding.step2_field": "fields",
    "onboarding.step3_title": "What is holding you back?",
    "onboarding.step3_desc": "Help us understand to suggest the right solution",
    "onboarding.step3_other": "Add another problem... (optional)",
    "onboarding.step3_submitting": "Completing profile and redirecting...",
    "onboarding.step3_finish": "Start learning now 🚀",
    "onboarding.please_wait": "Please wait...",

    // Onboarding Data
    "onboarding.role_student": "Student",
    "onboarding.role_student_desc": "Currently studying or preparing to graduate",
    "onboarding.role_professional": "Professional",
    "onboarding.role_professional_desc": "Want to improve skills in current job",
    "onboarding.role_changer": "Career Changer",
    "onboarding.role_changer_desc": "Want to change career direction",
    "onboarding.role_instructor": "Instructor / Expert",
    "onboarding.role_instructor_desc": "Want to share knowledge and build a personal brand",

    "onboarding.int_management": "Management & Leadership",
    "onboarding.int_management_desc": "Decision making, team management, strategic thinking",
    "onboarding.int_softskills": "Soft Skills & Communication",
    "onboarding.int_softskills_desc": "Presentation, negotiation, conflict resolution",
    "onboarding.int_it": "Programming & Technology",
    "onboarding.int_it_desc": "Python, web development, technical thinking",
    "onboarding.int_marketing": "Marketing & Media",
    "onboarding.int_marketing_desc": "Content, digital ads, brand building",

    "onboarding.pain_skills": "Lack of practical skills for jobs",
    "onboarding.pain_apply": "Can't apply what I learned to reality",
    "onboarding.pain_time": "No time for focused learning",
    "onboarding.pain_lonely": "Feel lonely, lack motivation studying online",
    "onboarding.pain_start": "Don't know where to start",
    "onboarding.pain_theory": "Content is too theoretical, outdated",
    ...
    "settings.language_desc": "Select the language used throughout the platform",
    "settings.profile": "Personal Profile",
    "settings.profile_desc": "Manage your identity and learning role",
    "settings.avatar": "Your avatar",
    "settings.role_q": "What is your current role?",
    "settings.name": "Full Name",
    "settings.phone": "Phone Number",
    "settings.save": "Save Changes",
    "settings.security": "Security",
    "settings.security_desc": "Manage your password and account safety",
    ...
    "settings.email_label": "Registered Email",
    "settings.no_change": "CANNOT BE CHANGED",
    "settings.save_expert": "Save Expert Profile",
    "settings.settings_desc": "Manage your personal preferences and system configuration.",
